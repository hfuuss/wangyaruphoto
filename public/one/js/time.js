function showTime() { 
	...
	var startDate = new Date(2019, 00, 13);
	...
	if (seconds < 10) 
	seconds = "0" + seconds; 
	var currentTimeString = "Dear RuRu:<br>"
		...
		+	"<c style=\"color: #CCCCCC; text-shadow:2px 3px 3px #222; font-family:Microsoft YaHei; font-size:20px\" >----九月大人  2020-01-01</c>"; 
